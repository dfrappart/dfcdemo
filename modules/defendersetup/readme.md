...
| <a name="input_DefenderCwppPlan"></a> [DefenderCwppPlan](#input\_DefenderCwppPlan) | The pricing for CWPP, can be Free or Standard | <pre>map(object({<br/>    enabled = optional(bool, false)<br/>    plan    = optional(string, "Standard")<br/>    subplan = optional(string, null)<br/>    extension = optional(set(string), [])<br/><br/><br/><br/>  }))</pre> | <pre>{<br/>  "AI": {<br/>    "enabled": true<br/>  },<br/>  "Api": {<br/>    "enabled": false,<br/>    "subplan": "P1"<br/>  },<br/>  "AppServices": {<br/>    "enabled": false<br/>  },<br/>  "Arm": {<br/>    "enabled": true,<br/>    "subplan": "PerSubscription"<br/>  },<br/>  "ContainerRegistry": {<br/>    "enabled": false<br/>  },<br/>  "Containers": {<br/>    "enabled": true<br/>  },<br/>  "CosmosDB": {<br/>    "enabled": false<br/>  },<br/>  "Dns": {<br/>    "enabled": true<br/>  },<br/>  "KeyVaults": {<br/>    "enabled": true,<br/>    "subplan": "PerKeyVault"<br/>  },<br/>  "KubernetesService": {<br/>    "enabled": false<br/>  },<br/>  "OpenSourceRelationalDatabases": {<br/>    "enabled": false<br/>  },<br/>  "SQLServers": {<br/>    "enabled": false<br/>  },<br/>  "SqlServerVirtualMachines": {<br/>    "enabled": false<br/>  },<br/>  "StorageAccounts": {<br/>    "enabled": true,<br/>    "subplan": "DefenderForStorageV2"<br/>  },<br/>  "VirtualMachines": {<br/>    "enabled": true,<br/>    "subplan": "P1"<br/>  }<br/>}</pre> | no |
...
| [random_string.suffixsta](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/string) | resource |
